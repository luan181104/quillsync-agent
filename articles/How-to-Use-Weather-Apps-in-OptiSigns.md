...
### Cold weather icon: a pale blue sun and snowflake badge

**Cold Weather \-** This icon displays if the temperature is \<\=58°F

### Mild weather icon: a yellow and magenta sun and snowflake badge

  
**Mild Weather \-** This icon displays if the temperature is between 59°F and 85°F.

### Hot weather icon: an orange sun and snowflake badge
